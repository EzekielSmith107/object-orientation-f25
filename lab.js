...
favoriteThings["show"] = "Sword Art Online";
...
function totalPopulation(object) {
  ...
  let sumOfPopulation = utah + california + texas + arizona;
...
//Code Here
const myFirstVehicle = new Vehicle(5, "grey", 55000);
...
//Code Here 
const myFirstMotorcycle = new Motorcycle(1, "red", 40000, "Honda", false);
...
//Code Here
const myFirstBoat = new Boat(6, "blue", 3000, "Loon Balloon", "pontoon", false);
